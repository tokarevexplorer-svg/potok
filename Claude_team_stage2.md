...
### Сессия 3 — Меню сайта и иерархия (этап 1, пункт 2)
...
### Сессия 4 — Раздел «Инструкции»: структура и переезд (этап 1, пункт 6)
...
### Сессия 5 — Раздел «Базы»: каркас и навигация (этап 1, пункт 13)
...
### Сессия 6 — Многослойная сборка промпта (этап 1, пункт 4)
...
### Сессия 7 — Наполнение Mission и Goals (этап 1, пункт 5)
...
### Сессия 8 — Таблица памяти агентов (этап 1, пункт 3)
...
### Сессия 9 — Таблица агентов и сервис (этап 2, пункт 7)
...
### Сессия 10 — Мастер создания агента + Awareness (этап 2, пункт 12)
...
### Сессия 11 — Карточка сотрудника (этап 2, пункт 12)
...
### Сессия 12 — Инвалидация кеша и интеграция Role в задачи (этап 2, пункт 12)
...
### Сессия 13 — Handoff и цепочки задач (этап 2, пункт 8)
...
### Сессия 14 — Парсер обратной связи и таблица эпизодов (этап 2, пункт 9)
...
### Сессия 15 — Сжатие эпизодов и экран «Кандидаты в правила» (этап 2, пункт 9)
...
### Сессия 16 — Дашборд: три пояса и лог с фильтрами (этап 3, пункт 14)
...
### Сессия 17 — Форма постановки задачи с выбором агента (этап 3, пункт 14)
...
### Сессия 18 — Inbox внимания и сквозной колокольчик (этап 3, пункт 14)
...
### Сессия 19 — Allowlist шаблонов задач в карточке агента — финализация (этап 3, пункт 14)
...
### Сессия 20 — Инструменты: реестр, методички и Awareness (этап 3, пункт 16)
...
### Сессия 21 — UI инструментов в Админке и карточке агента (этап 3, пункт 16)
